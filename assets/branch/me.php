      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="me.php">ME</a></li>
...
<div class="jumbotron text-center" style="background-image: url('../../img/me.png'); height: 100vh;">
...
<div class="container">
  <div class="row">
    <div class="col-sm-4 card">
      <h3>Notes</h3>
      <h4><a href="../pdfFiles/ee.pdf">Engineering Economy </a></h4>
      <h4><a href="../pdfFiles/mv.pdf">Mechanical Vibration </a></h4>
      <h4><a href="../pdfFiles/cch.pdf">Hydraulics & Pneumatics </a></h4>
      <h4><a href="../pdfFiles/or.pdf">Operations Research </a></h4>
    </div>
    <div class="col-sm-4 card">
      <h3>Syllabus</h3>
      <h4><a href="../pdfFiles/mesyl.pdf">CBCS VTU Syllabus </a></h4>
    </div>
    <div class="col-sm-4 card">
      <h3>More Info</h3>
