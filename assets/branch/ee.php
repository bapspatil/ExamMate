...
<html lang="en">
<head>
  <title>Electrical & Electronics Engineering Department</title>
  <meta charset="utf-8">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="ee.php">EEE</a></li>
...
<div class="jumbotron text-center" style="background-image: url('../../img/eee.png'); height: 100vh;">
  <div class="container" style="color: white; padding-top: 220px;">
  <h1>Electrical & Electronics Engineering Department</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4 card">
      <h3>Syllabus</h3>
      <h4><a href="../pdfFiles/eesyl.pdf">CBCS VTU Syllabus </a></h4>
      <h4><a href="../pdfFiles/eensyl.pdf">Non-CBCS VTU Syllabus </a></h4>
    </div>
    <div class="col-sm-4 card">
      <h3>More Info</h3>
