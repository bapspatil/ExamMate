      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="ce.php">CE</a></li>
...
<div class="jumbotron text-center" style="background-image: url('../../img/ce.png'); height: 100vh;">
...
<div class="container">
  <div class="row">
    <div class="col-sm-4 card">
      <h3>Notes</h3>
      <h4><a href="../pdfFiles/cee.pdf">Environmental Engineering </a></h4>
      <h4><a href="../pdfFiles/dss.pdf">Design of Steel Structure </a></h4>
      <h4><a href="../pdfFiles/ev.pdf">Estimation & Valuation </a></h4>
      <h4><a href="../pdfFiles/dcs.pdf">Design of Concrete Structures </a></h4>
      <h4><a href="../pdfFiles/hgd.pdf">Highway Geometric Design </a></h4>
      <h4><a href="../pdfFiles/pmc.pdf">PMC </a></h4>
    </div>
    <div class="col-sm-4 card">
      <h3>Syllabus</h3>
      <h4><a href="../pdfFiles/cesyl.pdf">CBCS VTU Syllabus </a></h4>
    </div>
    <div class="col-sm-4 card">
      <h3>More Info</h3>
